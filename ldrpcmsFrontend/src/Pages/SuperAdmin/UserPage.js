        ...
        <div className="flex flex-col w-full h-full relative">
            ...
            <div className="w-full">
                <div className="w-full h-full flex flex-wrap sm:gap-0 gap-5 items-center justify-between p-2 px-8 lg:p-9">
                    ...
                    <NavLink to="/superadmin/users/adduser" className="bg-primary-500 text-white flex flex-nowrap items-center px-3 py-2 gap-2 rounded-full w-fit h-12 purpleBtnShadow hover:-translate-y-1 transition-all group">
            ...
            <div className="w-full lg:w-[95%] mx-auto h-fit bg-white rounded-2xl shadow-md mb-10 overflow-hidden">
                ...
                <Grid
                    ...
                    data={activeUser.map((user) => [_(<UserImage gender={user.gender} name={user.name} />), user.name, user.email, user.role, _(<Actions setUserToDelete={setUserToDelete} userData={user} setUserToView={setUserToView} />)])}
                    search={false}
                    pagination={{
                        limit: 25,
                        summary: true,
