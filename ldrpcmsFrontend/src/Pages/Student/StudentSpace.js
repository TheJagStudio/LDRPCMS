    ...
    return (
        <div className="flex flex-col w-full h-full">
            <div className="w-full">
                <div className="w-full h-32 flex flex-wrap items-center justify-between p-2 -mb-2 mt-2 px-8 lg:p-9">
            ...
            <div className="w-[90%] lg:w-[95%] flex flex-nowrap mx-auto h-fit bg-white rounded-2xl shadowCustom mb-10 mt-0 overflow-hidden">
